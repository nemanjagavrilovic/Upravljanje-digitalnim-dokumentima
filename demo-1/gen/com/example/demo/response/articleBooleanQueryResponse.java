...
@XmlRootElement(name = "articleBooleanQueryResponse", namespace = "http://webService.demo.example.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "articleBooleanQueryResponse", namespace = "http://webService.demo.example.com/")

public class articleBooleanQueryResponse {
