...
@XmlRootElement(name = "articleFindByTitleRequest", namespace = "http://webService.demo.example.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "articleFindByTitleRequest", namespace = "http://webService.demo.example.com/", propOrder = {"title", "searchType"})

public class articleFindByTitleRequest {
